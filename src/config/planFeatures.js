 ...
 * 
 * Pricing Strategy:
 * - Free: $0/mes (friction alta para conversión)
 * - Starter: $29/mes (entrada fácil a pagos)
 * - Pro: $79/mes (para equipos reales)
 * - Enterprise: Custom pricing (soluciones corporativas)
 */
