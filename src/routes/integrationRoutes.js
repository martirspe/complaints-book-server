...
// Create claim via API key (requires scope claims:write)
router.post('/integrations/:slug/claims', apiKeyMiddleware, requireApiKeyScope('claims:write'), rateLimitTenant, auditMiddleware('integration:claim:create'), createClaim);
